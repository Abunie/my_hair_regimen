...
class CircleIndicator extends StatefulWidget {
  ...
  CircleIndicator({this.percent = 0.5,this.benefit});
  @override
        ...
        children: <Widget>[
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(widget.benefit.name,style: TextStyle(color: Colors.black),),
                Text(widget.benefit.weight,style: TextStyle(color: Colors.black),),
              ],
            ),
          ),
          Container(
